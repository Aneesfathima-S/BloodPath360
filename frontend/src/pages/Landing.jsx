        ...
        <div className="container mx-auto px-4 py-20 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 text-white text-sm font-medium mb-6 backdrop-blur-sm">
              ...
              Smart Systems for Life-Saving Care
            </div>
            ...
            <p className="text-lg md:text-xl text-red-100 mb-8 max-w-2xl mx-auto">
              BloodPath360 is an intelligent blood bank management platform that connects donors, hospitals, and laboratories through real-time tracking and smart matching—ensuring the right blood reaches the right patient at the right time, when every second matters.
            </p>
