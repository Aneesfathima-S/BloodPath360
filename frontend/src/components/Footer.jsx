        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">BloodPath360</h2>
          ...
          <div>
            ...
            <div className="mt-8 space-y-3">
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <span>Emergency Hotline: 1-800</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
                <Mail className="w-4 h-4 text-red-400" />
                <span>help@bloodpath360.org</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-400 text-sm">
              © {currentYear} BloodPath360. All rights reserved. Smart blood management  & Emergency responder.
            </div>
