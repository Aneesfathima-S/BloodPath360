...
const DashboardLayout = ({ userRole = "donor" }) => {
  ...
  const menuConfig = {
    donor: {
      title: "BloodPath360 Donor Portal",
    ...
    hospital: {
      title: "BloodPath360 Hospital Management",
    ...
    admin: {
      title: "BloodPath360 Admin Panel",
        ...
        >
          ...
          {!sidebarCollapsed && (
            <div className="p-4 border-t border-red-100">
              ...
              >
                <p className="text-sm font-semibold">BloodPath360</p>
                <p className="text-xs mt-1 opacity-75">Smart Systems for Life-Saving Care</p>
              </div>
            </div>
          )}
        </aside>
