...
const AboutUs = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      image: 'https://i.pinimg.com/1200x/28/9f/d6/289fd6f0ebfc1eca85536049d4b28761.jpg',
      ...
      <section className="relative py-20 mt-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            One Platform. One Network. Many Lives.
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
            Ensuring timely blood availability through intelligent matching and real-time tracking—connecting donors, hospitals, and labs.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                To save lives by ensuring timely, safe, and reliable access to blood through a centralized digital platform. BloodPath360 bridges the gap between voluntary blood donors, blood banks, and hospitals, enabling quick response during emergencies.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Real-Time Blood Inventory Tracking</span>
                </div>
              </div>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-lg text-gray-700 mb-6">
                To build a future where blood transfusion is seamless, transparent, and stress-free, powered by smart technology, real-time data, and a strong community of voluntary donors.
              </p>
              <div className="bg-red-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700">
                  Every unit of blood is digitally tracked and validated through multiple verification and safety checks, ensuring accuracy, traceability, and maximum safety for both donors and recipients.
                </p>
              </div>
            </div>
          </div>
