    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 px-6">
          ...
          <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
            ...
            <p className="text-gray-600">info@bloodpath360.org</p>
          </div>
          ...
          <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
            ...
            <p className="text-gray-600">India - 600001</p>
          </div>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">support@bloodpath360.org</span>
              </div>
              <div className="flex items-center">
                <MapPin className="text-red-600 mr-3" />
                <span className="text-gray-700">Chennai, TamilNadu</span>
              </div>
            </div>
      ...
      <section className="mb-5">
        <iframe
          ...
          src="https://maps.google.com/maps?q=Chennai%20Tamil%20Nadu&t=&z=13&ie=UTF8&iwloc=&output=embed"
          allowFullScreen
        ></iframe>
      </section>
